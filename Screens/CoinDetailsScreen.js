...
const CoinDetailsScreen = () => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#fff" }}>
      <StatusBar backgroundColor="#ffff" animated />
      <SafeAreaView>
        <View
          style={{
            flexDirection: "row",
        ...
        >
          ...
          <View style={{ alignItems: "flex-end" }}>
            <Text style={{ fontSize: Platform.OS === "android" ? 16 : 20 }}>
        ...
        >
          <View>
            <Text style={styles.txt_h}>Low</Text>
            <Text style={styles.txt_d}>
              {symbol === "$" ? symbol : symbol + " "}
              {item.low_24h}
            </Text>
          </View>
          <View>
            <Text style={styles.txt_h}>High</Text>
            <Text style={styles.txt_d}>
              {symbol === "$" ? symbol : symbol + " "}
              {item.high_24h}
            </Text>
          ...
          <View>
            <Text style={styles.txt_h}>Vol</Text>
            <Text style={styles.txt_d}>
